...
void Game::Frame(engine::Renderer& r, engine::DirectInput& dInput, engine::Timer& timer){
	...
	*/
	...
	mainCamera->RotateRight(dInput.mouseRelPosX() * mSpeed / 100 * timer.timeBetweenFrames());
	...
	*/
	...
	mainCamera->RotateDown(dInput.mouseRelPosY() * mSpeed / 100 * timer.timeBetweenFrames());
